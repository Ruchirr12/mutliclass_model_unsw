...
filename = 'logistic_regressor_multi.pkl'
classifier = pickle.load(open(filename,'rb'))
model = pickle.load(open('logistic_regressor_multi.pkl','rb'))
...
def predict_value():
    ...
    return render_template('result.html', prediction_text='Following Diagnosis is made:{}'. format(resvalue))
